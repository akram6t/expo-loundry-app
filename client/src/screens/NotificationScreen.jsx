...
const NotificationScreen = ({ navigation }) => {
  ...
  function NotificationItem({ item }) {
    ...
    return (
      <View style={{ opacity: status === 'read' ? 0.5 : 1, margin: 5, borderRadius: 10, borderWidth: 1, borderColor: MD2Colors.grey300, paddingHorizontal: 5, paddingVertical: 8, backgroundColor: item.color ? item.color + '2A' : 'white', flexDirection: 'row', justifyContent: 'space-between' }}>
